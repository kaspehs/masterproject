...
FULL_TIMESERIES_NPZ_DIR = Path("CFD_Data/npz_exports")
...
def _dominant_frequency(signal: np.ndarray, dt: float) -> float:
    """FFT peak frequency with the same basic behavior as HNN_helper."""
...
def save_diagnostic_plot(
    ...
    *,
    ...
    for ax, key in zip(axes_flat, METRIC_KEYS):
        ...
        ax.scatter(anchor_ur, anchor_y, color="black", s=34, zorder=3, label="real anchors used")
