...
class BasicMLP(nn.Module):
    """
    Simple fully connected backbone with optional Fourier feature encoding.
    """
    def __init__(self,
                 input_dim: int,
                 hidden_dim: int,
...
class SirenMLP(torch.nn.Module):
    """
    SIREN-based MLP using sine activations, suitable for smooth periodic signals with
...
class PirateNet(torch.nn.Module):
    ...
    Features:
      ...
      - Periodic-friendly and suitable for higher-order derivative losses
